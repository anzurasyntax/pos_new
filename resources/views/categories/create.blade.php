<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-slate-900 leading-tight">Add category</h2>
    </x-slot>
                ...
                <form method="POST" action="{{ route('categories.store') }}">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-0.5 mb-2">Leave as “None” for a top-level category.</p>
                        ...
                        <x-input
                            ...
                            name="sort_order"
                            type="number"
                            placeholder="Optional (lower shows first)"
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-end gap-3 mt-6">
                        ...
                        <x-button type="primary" htmlType="submit" text="Save category" loadingText="Saving..." />
                    </div>
                </form>
            </div>
        </div>
