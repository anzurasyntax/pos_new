                ...
                <form method="POST" action="{{ route('products.update', $product) }}">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-0.5 mb-2">Optional. <a href="{{ route('categories.index') }}" class="text-emerald-700 font-medium hover:underline">Manage categories</a>.</p>
                            <select id="category_id" name="category_id"
                                ...
                                @foreach ($categoryOptions as $opt)
                                    <option value="{{ $opt['id'] }}" @selected(old('category_id', $product->category_id) == $opt['id'])>
                                        {{ $opt['label'] }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="mt-6 border-t pt-6">
                        <div class="flex items-center justify-between gap-3 mb-3">
                            <div>
                                <h3 class="text-base font-semibold text-gray-800">Product Variants</h3>
                                <p class="text-sm text-gray-600">Edit or add variants below. If variants exist, Sales/Purchases use them.</p>
                            </div>
                            <x-button
                                type="primary"
                                htmlType="button"
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody id="variantsBody">
                                    @php
                                        ...
                                        $variants = is_array($oldVariants) ? $oldVariants : $product->variants->map(fn($v) => [
